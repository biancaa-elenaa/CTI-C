...
def filterr(fnc, lista):
    return functools.reduce(lambda acc,elem:acc + [elem] if fnc(elem) is True else acc,lista,[])
...
if __name__ == '__main__':
    ...
    print(lista_cifre([2,1,5,8], lambda nr: nr % 2 == 0))
    ...
    print(filterr(lambda x: x%2==0,[1,2,3,4,5,6]))